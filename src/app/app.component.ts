...
@Component({
  ...
  imports: [CommonModule, RouterOutlet, ProductCategoryMenuComponent, SearchComponent, CartStatusComponent],  // Declara los módulos y componentes que se usarán en este componente.
